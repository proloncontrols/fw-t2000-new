...
extern const unsigned char image_menu_button_496x496x76[]; // BITMAP_MENU_BUTTON_496X496X76_ID = 1, Size: 496x496 pixels
extern const unsigned char image_menu_line_gray_494x494x4[]; // BITMAP_MENU_LINE_GRAY_494X494X4_ID = 2, Size: 494x494 pixels
extern const unsigned char image_outside_24x24[]; // BITMAP_OUTSIDE_24X24_ID = 3, Size: 24x24 pixels
extern const unsigned char image_setting[]; // BITMAP_SETTING_ID = 4, Size: 50x50 pixels
extern const unsigned char image_setting_dark2[]; // BITMAP_SETTING_DARK2_ID = 5, Size: 50x50 pixels
