...
extern const unsigned char image_menu_selected_496x496x76[]; // BITMAP_MENU_SELECTED_496X496X76_ID = 6, Size: 496x496 pixels
...
const touchgfx::Bitmap::BitmapData bitmap_database[] = {
    ...
    { image_menu_selected_496x496x76, 0, 496, 496, 28, 1, 440, ((uint8_t)touchgfx::Bitmap::ARGB8888) >> 3, 72, ((uint8_t)touchgfx::Bitmap::ARGB8888) & 0x7 },
