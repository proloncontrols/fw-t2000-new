...
const uint16_t BITMAP_MENU_BUTTON_ID = 2;
const uint16_t BITMAP_MENU_LINE_GRAY_494X494X3_ID = 3;
const uint16_t BITMAP_MENU_LINE_WHITE_496X496X5_ID = 4;
const uint16_t BITMAP_OUTSIDE_24X24_ID = 5;
const uint16_t BITMAP_PROLON_176X176_ID = 6;
