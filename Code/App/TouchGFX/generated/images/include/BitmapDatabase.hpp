...
const uint16_t BITMAP_BLUE_BUTTONS_ROUND_EDGE_SMALL_270_ID = 1;
const uint16_t BITMAP_BLUE_BUTTONS_ROUND_EDGE_SMALL_PRESSED_ID = 2;
const uint16_t BITMAP_BLUE_BUTTONS_ROUND_EDGE_SMALL_PRESSED_270_ID = 3;
const uint16_t BITMAP_BLUE_ICONS_DOWN_ARROW_48_ID = 4;
const uint16_t BITMAP_BLUE_ICONS_UP_ARROW_48_ID = 5;
